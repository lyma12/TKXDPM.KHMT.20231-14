...
public class PlaceOrderController extends BaseController {
	...
	private void validateDeliveryInfo(HashMap<String, String> info) throws InterruptedException, IOException{
    	if(!validateName(info.get("name"))) throw new InvalidDeliveryInfoException();
    	if(!validatePhoneNumber(info.get("phone"))) throw new InvalidDeliveryInfoException();
    	if(!validateAddress(info.get("province"))) throw new InvalidDeliveryInfoException();
    }
