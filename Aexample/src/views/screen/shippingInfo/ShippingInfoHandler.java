...
public class ShippingInfoHandler extends BaseScreenHandler{
	...
	private void notifyError() {
		...
		if(this.name.getText().isBlank() || this.name.getText().isEmpty()) {
			this.name_error.setVisible(true);
			return;
		}
		else this.name_error.setVisible(false);
		
		if(this.phone.getText().isBlank() || this.phone.getText().isEmpty()) {
			this.phone_error.setVisible(true);
			return;
		}
		...
		if(this.province.getValue() == null || this.province.getValue().isEmpty() || this.province.getValue().isBlank()) {
			this.province_error.setVisible(true);
			return;
		}
